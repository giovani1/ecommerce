...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
     	<h3><span class="glyphicon glyphicon-briefcase" > Inscription</span></h3>
      <hr/>
      <div class="col-sm-offset-2 col-sm-8">
      <form class="form-horizontal" method="Post" action="<c:url value="/seller/add"/>">
      ...
      <label class=" validationError" ><c:out value='${usedEmail}'/></label>
